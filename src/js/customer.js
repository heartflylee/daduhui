...
for (var i = 0; i < datalength; i++) {
  ...
  var username = ['', '新飞'];
  var mainProduce = [
    '经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1经营范围1',
    '',
    '经营范围2经营范围2经营范围2经营范围2经营范围2经营范围2经营范围2经营范围2',
    '',
    '经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3经营范围3',
  ];
  ...
  dataRow.isDistribution =
    fileterReset.isDistribution[parseInt(Math.random() * 2)];
  ...
  dataRow.endcallMsgStatus =
    fileterReset.endcallMsgStatus[parseInt(Math.random() * 4)];
...
//默认显示表头
var tablehead =
  'cellphone,position,progress,createdTime,lastActionTime,userName,company,comAdress,comType,mainProduce,operName,registCapi,customerSource,isDistribution';
if (
  $.trim(tablehead) == 'null' ||
  $.trim(tablehead) == '' ||
  tablehead == '0'
  ...
  tablehead =
    'cellphone,position,progress,createdTime,lastActionTime,company,customerSource,email,wechat,qq';
}
...
var defaultCulumns = {
  ...
  cusname: {
    ...
    cellsrenderer: function(row, column, value, defaultHtml, style, rowData) {
      ...
      if (rowData.lock == 1) {
        ...
        return (
          '<i class="icon-lock"></i><div class="jqx-grid-cell-left-align">' +
          value +
          '</div>'
        );
      }
  ...
  mainProduce: {
    ...
    cellsrenderer: function(row, column, value, defaultHtml, style, rowData) {
      var mainProduce =
        '<div class="jqx-grid-cell-text" style="margin-right: 30px;overflow: hidden;text-overflow: ellipsis" title="' +
        value +
        '">' +
        value +
        '</div>';
...
function listMove(directionIndex) {
  ...
  if (directionIndex >= 2 && item.length > 0 && item[0] != undefined) {
    ...
    $obox.jqxListBox(
      'insertAt',
      { label: item[0].label, value: item[0].value },
      Addindex
    );
