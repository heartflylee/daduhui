...
(function (h, o, g) {
    var p = function () {
        for (var b = /audio(.min)?.js.*/, a = document.getElementsByTagName('script'), c = 0, d = a.length; c < d; c++) {
            ...
            if (b.test(e)) return e.replace(b, '').replace('js', 'img')
        }
    }();
    g[h] = {
        instanceCount: 0,
        ...
        settings: {
            ...
            css: '.audiojs audio{position:absolute;left:-1px}.audiojs{float:left;height:36px;overflow:hidden;font-family:monospace;font-size:12px}.audiojs .playname{float:left;height:36px;line-height:36px;color:#fff;padding:0 8px 0 6px}.audiojs .play-pause{width:25px;height:40px;padding:4px 6px;margin:0;float:left;overflow:hidden}.audiojs p{display:none;width:25px;height:40px;margin:0;cursor:pointer}.audiojs .play{display:block}.audiojs .scrubber{position:absolute;width:100%;top:0;left:0;background:#5a5a5a;height:5px;overflow:hidden}.audiojs .progress{position:absolute;top:0;left:0;height:5px;width:0;background:#ccc;z-index:1}.audiojs .loaded{position:absolute;top:0;left:0;height:14px;width:0}.audiojs .time{float:left;height:36px;line-height:36px;padding:0 6px;color:#ddd}.audiojs .time em{padding:0 2px 0 0;color:#f9f9f9;font-style:normal}.audiojs .time strong{padding:0 0 0 2px;font-weight:400}.volume{width:14px;height:14px;margin:11px 6px;float:left;background:url(../img/voice.png);cursor:pointer}.closing .volume{background:url(../img/voice-no.png)}.audiojs .error-message{float:left;display:none;margin:0 10px;height:36px;width:400px;overflow:hidden;line-height:36px;white-space:nowrap;color:#fff}.audiojs .error-message a{color:#eee;text-decoration:none;white-space:wrap}.audiojs .play{background:url($1) -2px -1px no-repeat}.audiojs .loading{background:url($1) -2px -31px no-repeat}.audiojs .error{background:url($1) -2px -61px no-repeat}.audiojs .pause{background:url($1) -2px -91px no-repeat}.playing .error,.playing .loading,.playing .play{display:none}.playing .pause{display:block}.loading .error,.loading .pause,.loading .play{display:none}.loading .loading{display:block}.error .loading,.error .pause,.error .play,.error .playname,.error .scrubber,.error .time,.error .volume{display:none}.error .error{display:block}.error .play-pause p{cursor:auto}.error .error-message{display:block}',
            trackEnded: function () {
            },
            flashError: function () {
