    ...
    columns: [
      ...
      },
      {
        ...
        cellsrenderer: function(
          ...
          if (
            rowData.taskType == '进行中' ||
            rowData.taskType == '过期未完成'
          ) {
            return '<a class="btn btn-link" href="javascript:linkHref()">查看详情</a> <a class="btn  btn-link btn-link-danger" href="javascript:stopTaskBtn()">终止任务</a>';
