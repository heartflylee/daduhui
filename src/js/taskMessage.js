...
$(document).ready(function () {
    ...
    $("#jqxtable").jqxGrid({
        ...
        columns: [
            ...
            {
                text: '创建时间', datafield: 'startTime', width: 110
            },
            {
            ...
            {
                text: '绑定执行人', datafield: 'progress', width: 100
            },
            {
                text: '发送模板', datafield: 'repetitions', minwidth: 90
            },
            {
                text: '数据来源', datafield: 'source', minwidth: 50
            },
            {
                text: '发送条数/成功条数', datafield: 'sendNum', width: 150,
            ...
            },
            {
                ...
                cellsrenderer: function (row, column, value, defaultHtml, style, rowData) {
                    return '<a class="btn btn-link" href="linkHref()">查看详情</a>';
